...
(def ^:private ResultColumnMetadata
  ...
  {:name                                s/Str
   ...
   :base-type                           su/FieldTypeKeywordOrString
   (s/optional-key :semantic-type)      (s/maybe su/FieldSemanticOrRelationTypeKeywordOrString)
   ...
   (s/optional-key :field-ref)          (s/cond-pre
   ...
   (s/optional-key :converted-timezone) (s/pred mbql.preds/TimezoneId?)
   s/Keyword                            s/Any})
